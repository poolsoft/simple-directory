		...
		<?php the_title( '<span itemprop="name"><h3 class="entry-title"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a> &nbsp;<i class="fi-star"></i></h3><span>' ); ?>
			...
			<div class="medium-3 small-4 columns">
				...
				<span class="show-for-small">
					<?php if($dir_meta['listing_phone_1'][0] !='') {?><a href="tel:+1<?php echo $dir_meta['listing_phone_1'][0];?>" class="button small radius">CALL NOW</a><?php }?>
				</span>
				<a href="' . esc_url( get_permalink() ) . '" class="button small radius"><i class="fi-list-thumbnails"></i> DETAILS</a>
